  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView edges={["top", "bottom"]} style={styles.safeArea}>
        {/* 🌈 Gradient background (same as sign-in) */}
        <LinearGradient
          colors={[
            "rgba(250, 255, 230, 0.95)", // top: soft sunlight tone
            "rgba(220, 255, 230, 0.95)", // bottom: gentle minty green
          ]}
          start={{ x: 0.5, y: 0 }}
          end={{ x: 0.5, y: 1 }}
      ...
      {/* 🖤 Status bar (white icons, black background) */}
...
const styles = StyleSheet.create({
  root: {
    flex: 1,
    backgroundColor: "black", // keeps borders black
  },
  safeArea: {
    flex: 1,
  ...
  optionBtnSelected: {
    backgroundColor: "rgba(90, 193, 142, 0.3)", // green tint when selected
    borderColor: "#5ac18e",
  },
  optionText: {
    fontSize: 17,
